...
<table width="100%" class="table_form contentWrap">
    ...
    <tr>
        <th>出生日期：</th>
        <td><input type="text" name="User[birthday]" id='birthday' class="date input-text" value="<?=$model->birthday?>"></td>
    </tr>
...
<script>
    $(function () {
        ...
        $("#email").formValidator({onshow: "", onfocus: "", oncorrect: ""}).regexValidator({regexp:"^$|"+regexEnum.email,onerror:"手机号格式错误"});
